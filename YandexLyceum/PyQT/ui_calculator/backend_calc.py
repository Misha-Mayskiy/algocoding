...
class CalculatorApp(QWidget, Ui_Form):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
        self.current_value = ""
        ...
        self.btn0.clicked.connect(lambda: self.add_digit("0"))
        self.btn1.clicked.connect(lambda: self.add_digit("1"))
        self.btn2.clicked.connect(lambda: self.add_digit("2"))
        self.btn3.clicked.connect(lambda: self.add_digit("3"))
        self.btn4.clicked.connect(lambda: self.add_digit("4"))
        self.btn5.clicked.connect(lambda: self.add_digit("5"))
        self.btn6.clicked.connect(lambda: self.add_digit("6"))
        self.btn7.clicked.connect(lambda: self.add_digit("7"))
        self.btn8.clicked.connect(lambda: self.add_digit("8"))
        self.btn9.clicked.connect(lambda: self.add_digit("9"))
        self.btn_dot.clicked.connect(lambda: self.add_digit("."))

        # Operations
        self.btn_plus.clicked.connect(lambda: self.set_operation("+"))
        self.btn_minus.clicked.connect(lambda: self.set_operation("-"))
        self.btn_mult.clicked.connect(lambda: self.set_operation("*"))
        self.btn_div.clicked.connect(lambda: self.set_operation("/"))
        self.btn_pow.clicked.connect(lambda: self.set_operation("^"))
    ...
    def set_operation(self, operation):
        if self.current_value:
            self.last_number = float(self.current_value)
    ...
    def calculate_result(self):
        if self.last_operation and self.current_value:
            current_number = float(self.current_value)
            result = 0

            if self.last_operation == "+":
                result = self.last_number + current_number
